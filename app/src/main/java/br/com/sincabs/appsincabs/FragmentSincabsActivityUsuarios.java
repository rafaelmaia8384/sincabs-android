...
public class FragmentSincabsActivityUsuarios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.fragment_sincabsactivity_usuarios, container, false);
        }
    ...
    private void processData() {
        ...
        listaUsuariosAdapter.setOnLoadMoreListener(new ListaUsuarioAdapter.OnLoadMoreListener() {
            ...
            public void onLoadMore(int index) {
                ...
                SincabsActivity.sincabsServer.usuariosMaisAtivos(index, new SincabsResponse() {
        ...
        SincabsActivity.sincabsServer.usuariosMaisAtivos(1, new SincabsResponse() {
